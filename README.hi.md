...
pnpm exec playwright install chromium   # केवल PDF generation के लिए ज़रूरी

# 2. Setup check करें
pnpm run doctor                     # सभी prerequisites validate करता है
...
```bash
pnpm run serve:dashboard   # TUI launch करें
pnpm run build:dashboard   # optional: standalone binary build करें
```
