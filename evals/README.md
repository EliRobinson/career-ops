...
```bash
pnpm run eval:golden -- --replay --model cheap-stub   # offline, deterministic, $0
pnpm run eval:golden -- --live   --model gpt-4o-mini  # real call via openai-eval.mjs (needs key + cv.md)
```
