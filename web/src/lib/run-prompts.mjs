 ...
 *
 * @param {{kind: string, input: string, memory: string, today: string, fetchUrl?: string, postedAt?: string}} args
 * @returns {string}
 */
export function buildPrompt({ kind, input, memory, today, fetchUrl, postedAt }) {
